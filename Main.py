...
main = Tk()
main.title("DETECTION OF FAKE NEWS AND DATA THROUGH IMPLEMENTATION OF DATA SCIENCE APPLICATION")
...
font = ('times', 15, 'bold')
title = Label(main, text='DETECTION OF FAKE NEWS AND DATA THROUGH IMPLEMENTATION OF DATA SCIENCE APPLICATION')
